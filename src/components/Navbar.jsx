...
const Navbar = ({setcategory}) => {
  ...
  <div className="container-fluid">
    <a className="navbar-brand" href="#"><span className='badge bg-light text-dark fs-4'>NEWS_APP</span></a>
      ...
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item dropdown">
          ...
          <ul className="dropdown-menu">
            <li><a className="dropdown-item"  onClick={()=>setcategory("sports")}>Sports News</a></li>
            ...
            <li><a className="dropdown-item" href="#">Local Level News</a></li>
          </ul>
        </li>
